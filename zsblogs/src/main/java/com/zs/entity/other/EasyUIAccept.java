...
public class EasyUIAccept {
    ...
    //--------
    private List<Integer> strList1;

    private List<Integer> strList2;

    private List<Integer> strList3;
    ...
    public void setIntList2(List<Integer> intList2) {
        this.intList2 = intList2;
    }

    public List<Integer> getIntList3() {
        return intList3;
    }

    public void setIntList3(List<Integer> intList3) {
        this.intList3 = intList3;
    }

    public List<Integer> getStrList1() {
        return strList1;
    }

    public void setStrList1(List<Integer> strList1) {
        this.strList1 = strList1;
    }

    public List<Integer> getStrList2() {
        return strList2;
    }

    public void setStrList2(List<Integer> strList2) {
        this.strList2 = strList2;
    }

    public List<Integer> getStrList3() {
        return strList3;
    }

    public void setStrList3(List<Integer> strList3) {
