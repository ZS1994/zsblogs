...
public class FundInfoConR extends BaseRestController<FundInfo, String>{
	...
	public Result<FundInfo> doGet(String id, HttpServletRequest req, HttpServletResponse resp) {
		if(id!=null){
			try {
	...
	@Override
	public Result<String> doAdd(FundInfo obj, HttpServletRequest req, HttpServletResponse resp) {
		if(obj!=null){
			try {
	...
	@Override
	public Result<String> doUpdate(FundInfo obj, HttpServletRequest req, HttpServletResponse resp) {
	...
	public Result<String> doDeleteFalse(String id, HttpServletRequest req, HttpServletResponse resp) {
		if(id!=null){
			try {
	...
	public Result<String> doDeleteTrue(String id, HttpServletRequest req, HttpServletResponse resp) {
		return null;
	}
